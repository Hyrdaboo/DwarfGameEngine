...
class app extends Application {
	...
	public void OnUpdate() {
		clear(Color.gray);
		Vector3[] t1 = new Vector3[] { new Vector3(0, 0, 0), new Vector3(0, 1, 0), new Vector3(1, 1, 0), };
		Vector2[] c1 = new Vector2[] { new Vector2(0, 1), new Vector2(0, 0), new Vector2(1, 0), };
		Vector3[] t2 = new Vector3[] { new Vector3(1, 1, 0), new Vector3(1, 0, 0), new Vector3(0, 0, 0) };
		Vector3[] c2 = new Vector3[] { new Vector3(1.0f, 1.0f, 0.0f), new Vector3(1.0f, 0.0f, 0.0f),
	...
	frag f = new frag();
	Tex tex = new Tex("res/Textures/uvtest.png");
}
