...
/**
 * Basic font rendering. Does not support font files or any advanced features.
 * Uses image font atlas that consists of printable ASCII characters: <br>
 * !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~
 * <br>
 * <br>
 * If you want to change the font you will need to create a Texture atlas using
 * the charset mentioned above. You can use
 * <a href="https://lucide.github.io/Font-Atlas-Generator/">Font Atlas
 * Generator</a> to create your own font atlas
 */
public class Text {
	...
	/**
	 * Spacing of characters when being drawn.<br>
	 * Can be negative. Default value is 0
	 */
	 ...
	 *
	 * @param fontAtlas     A texture that contains all the characters from ASCII
	 *                      printable charset
	...
	public void draw(Vector2 position, Vector2 scale) {
		...
		for (Texture t : charImages) {
			if (t == null) {
				pos.y += (charSize + spacing) * scale.y;
				pos.x = position.x;
				continue;
			}
			DisplayRenderer.DrawImage(pos, size, t);
			pos.x += (charSize + spacing) * scale.x;
		}
	}
}
