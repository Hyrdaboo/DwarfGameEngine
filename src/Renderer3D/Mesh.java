...
/**
 * Represents a mesh, which is a collection of vertices and polygons, used for
...
public final class Mesh {
	 ...
	 * @throws IllegalArgumentException if the size of the triangles array is not
	 *                                  divisible by 3.
	 */
	 ...
	 * @throws IllegalArgumentException if the size of the uvs array is not equal to
	 *                                  the vertex count.
	 */
	 ...
	 * @throws IllegalArgumentException if the size of the colors array is not equal
	 *                                  to the vertex count.
	 */
	 ...
	 * @throws IllegalArgumentException if the size of the normals array is not
	 *                                  equal to the vertex count.
	 */
