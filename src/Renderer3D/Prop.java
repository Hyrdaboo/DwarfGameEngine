...
/**
 * The <code>Prop</code> class represents an entity in the 3D scene that can be rendered.
 * It holds a reference to the {@link Mesh} of the object and manages its transformation in the 3D scene and the shader used for rendering.
 */
